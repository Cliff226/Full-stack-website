...
$db   = "loginsystem";  // Name of the database you want to connect to
...
try {
    ...
    // If connection fails the errro is log for the developer
    error_log("Database Connection Error: " . $e->getMessage());
    // A generic message is shown to the user to not expose sensitive info
